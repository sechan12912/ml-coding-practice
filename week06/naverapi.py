...
client_id = 'yRPNzjwg1w3kMYbDDMNM'
client_secret = 'mZqhcalcQ_'
...
def getRequestUrl(url):
    ...
    req.add_header("X-Naver-Client-Id", "yRPNzjwg1w3kMYbDDMNM")
    req.add_header("X-Naver-Client-Secret", "mZqhcalcQ_")
